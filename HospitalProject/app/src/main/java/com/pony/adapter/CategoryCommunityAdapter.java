...
public class CategoryCommunityAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	private List<CCModel> list_result ;
	private int posIndex;
	public CategoryCommunityAdapter(Context context, List<CCModel>  list_result) {
...
//		try {
			holder.message_name.setText(list_result.get(position).getCcName());
//		} catch (Exception e) {
//		}
