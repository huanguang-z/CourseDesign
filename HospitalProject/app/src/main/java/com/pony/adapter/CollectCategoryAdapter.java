...
public class CollectCategoryAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	private List<CollectModel> list_result ;
	private int posIndex;
	public CollectCategoryAdapter(Context context, List<CollectModel>  list_result) {
...
//		try {
			holder.message_name.setText(list_result.get(position).getcCategoryName());
//		} catch (Exception e) {
//		}
