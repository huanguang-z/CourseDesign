...
<script type="text/javascript">
 function dosubmit(){
   ...
   th.action="<%=path%>/servlet/HospitalAction?action_flag=addBannerPC";
		th.submit();
	}
</script>
</head>
		...
		<div class="formbody">
			...
			<ul class="forminfo">
				...
				<div class="vocation">
							...
							%>
							<option value="<%=map.get("doctorId")%>,<%=map.get("doctorName")%>"><%=map.get("doctorName")%></option>
				...
				<li><label>展示图片</label><input name="bookImage" type="file" class="dfinput" size="60"></li>
